...
function dialogDrag(oDrag,oTitle){
	...
	//var RevertWidth = oDrag.offsetWidth;
	//var RevertHeight = oDrag.offsetHeight;
	var RevertWidth=600;
	var RevertHeight=320;
	//var oContent = get.byClass("content",oDrag)[0];
	//oContent.style.width = RevertWidth-2+'px';
	//oContent.style.height = RevertHeight - get.byClass("title",oDrag)[0].offsetHeight-10 +'px';
